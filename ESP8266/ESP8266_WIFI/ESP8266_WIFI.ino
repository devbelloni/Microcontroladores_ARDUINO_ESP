...
const char* ssid = "VIVO-7F38"; //VARIÁVEL QUE ARMAZENA O NOME DA REDE SEM FIO EM QUE VAI CONECTAR
const char* password = "4J4KAFw7wJ"; //VARIÁVEL QUE ARMAZENA A SENHA DA REDE SEM FIO EM QUE VAI CONECTAR
...
client.println("<meta http-equiv='refresh' content='5;URL=http://192.168.15.6'>");
client.println("<h1><center>STKALI ENGENHARIA</center></h1>"); //ESCREVE "Ola cliente!" NA PÁGINA
